...
| `small-portions.md` | Анти-таймаут: дробление сложных задач (симлинк на глобальный) |
| `init-session.md` | Принудительная инициализация: чтение всех *.md проекта, карт и активация token-saver |
...
- "начало сессии" или "/init-session" — для принудительного чтения всех файлов проекта
